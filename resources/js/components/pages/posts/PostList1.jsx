...
export default function PostList() {
  ...
  const handleCategoryChange = (selectedOptions) => {
    ...
    setFormData({
      ...formData,
      category_id: selectedOptions.map(option => option.value)
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (currentPost) {
        ...
        const res = await api.post(`/posts/${currentPost.id}`, formDataToSend, {
          headers: {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <Select
                    ...
                    className={`react-select-container ${errors.category_id ? 'has-error' : ''}`}
...
{/* 
              ...
              <div className="mb-4">
                ...
                <RichTextEditor body={body} onChange={handleEditorChange} className="min-h-[300px] p-4 bg-white focus:outline-none prose prose-sm sm:prose lg:prose-lg xl:prose-xl max-w-none" />
